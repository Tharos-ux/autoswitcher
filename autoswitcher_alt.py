...
if __name__ == "__main__":
    ...
    DEVICES: list[tuple] = [(1, None), (8, None), (3, None), (6, None)]
    BUFFERS: list[list] = [[] for _ in USERS]
    NORMALISER: list[int] = [3, 1, 1, 1]
    ...
    # init memories
    THRESHOLD: int = 5
    USERS: list[str] = ['Tharos', 'Yoka', 'Invité_1']
    DEVICES: list[tuple] = [(4, None), (7, None), (5, None)]
    BUFFERS: list[list] = [[] for _ in USERS]
    NORMALISER: list[int] = [3, 1, 1]
